...
normalisiert die Werte aus jeder Batch (Daten die parallel verarbeitet werden) 
die der Dense/ConvLayer "ausgibt" um Werte die zuweit links/rechts liegen anzupassen, 
damit das Netz konsistent in einem Bereich bleibt.

wird nach dem Conv2D oder Dense Layer eingefügt also VOR der Aktivierungsfunktion.
