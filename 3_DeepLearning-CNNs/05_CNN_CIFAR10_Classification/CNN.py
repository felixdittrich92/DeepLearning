import os
os.environ['TF_CPP_MIN_LOG_LEVEL'] = '3' # disable all infos show only errors

import random
# random.seed(0) liefert immer dieselben Werte

import numpy as np
# np.random.seed(0) liefert immer dieselben Werte
...
from Dataset_class import CIFAR10
...
# Save Path
dir_path = os.path.abspath("../DeepLearning/models/CIFAR10/")
cifar_model_path = os.path.join(dir_path, "cifar_model.h5")
# Log Dir
log_dir = os.path.abspath("../DeepLearning/logs/CIFAR10/")
